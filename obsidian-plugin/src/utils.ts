...
/**
 * Save project _project.yml and _style.yml files.
 */
export function saveProjectFiles(
  ...
  let projYml = '# Auto-generated by Auto CV plugin\n';
  projYml += 'include:\n';
  ...
  if (data.titleOverride) {
    projYml += `\nconfig:\n  title: "${data.titleOverride}"\n`;
  }
  writeFileSync(join(projectDir, '_project.yml'), projYml, 'utf-8');
